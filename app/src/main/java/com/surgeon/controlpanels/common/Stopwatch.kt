...
//    fun lap():ArrayList<LapModel> {
//        if (laps.isEmpty()) {
//            val lap = LapModel(currentLap++, lapTicks * UPDATE_INTERVAL, totalTicks * UPDATE_INTERVAL)
//            laps.add(0, lap)
//            lapTicks = 0
//        } else {
//            laps.first().apply {
...
//    }
    ...
    fun lap(): ArrayList<LapModel> {
        val lap = LapModel(currentLap++, lapTicks * UPDATE_INTERVAL, totalTicks * UPDATE_INTERVAL)
        laps.add(0, lap)  // Add the new lap at the beginning of the list
        lapTicks = 0  // Reset lapTicks for the next lap
